...
export class EventBookingFormContainer extends React.Component<EventBookingFormContainerProps, EventBookingFormContainerState>{
  constructor(p: EventBookingFormContainerProps) {
    ...
    if(this.props.eventServiceURL === ""){
        alert('eventServiceURL is undefined');
    }
    console.log(this.props.eventServiceURL);
  }
  ...
  componentDidMount() {
    ...
    fetch(this.props.eventServiceURL + "/events/" + id, { method: "GET" })
